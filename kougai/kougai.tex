...
しかし，スクワットには正しいフォームが複数存在する．
負荷を軽減させたい関節や，優先的に働かせたい筋肉によって，足幅，体幹の前傾角度，すねの角度，つま先の向き，重心の位置，しゃがむ深さ，さらには股関節主導か膝関節主導かといった要素を個々に調整する必要がある\cite{squat}．
すなわち，トレーニングの目的に応じて最適なフォームは異なるという点が，スクワット指導における本質的な難しさである．
...
\begin{figure}[h]
\begin{center}
 \includegraphics[clip,width=85mm,height=55mm]{motion_capture.png}
\end{center}
